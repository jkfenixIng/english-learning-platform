...
export default async function AdminUnitsPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <form className="rounded border p-4 dark:border-gray-700" aria-label="Create unit form"><h2 className="font-semibold">Create Unit</h2><input name="title" placeholder="Unit title" className="mt-2 w-full rounded border px-2 py-1" /><button type="submit" className="mt-2 rounded bg-indigo-600 px-4 py-2 text-sm text-white">Create (stub)</button></form>
    </div>
  );
}
