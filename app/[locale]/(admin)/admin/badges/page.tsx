...
export default async function AdminBadgesPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <form className="rounded border p-4 dark:border-gray-700" aria-label="Create badge form"><h2 className="font-semibold">Create Badge (stub)</h2><input name="code" placeholder="c1_complete" className="mt-2 w-full rounded border px-2 py-1" /><button type="submit" className="mt-2 rounded bg-indigo-600 px-4 py-2 text-sm text-white">Create</button></form>
    </div>
  );
}
