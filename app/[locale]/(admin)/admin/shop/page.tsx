...
export default async function AdminShopPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <form className="rounded border p-4 dark:border-gray-700" aria-label="Create shop item form"><h2 className="font-semibold">Create Shop Item (stub)</h2><input name="title" placeholder="Premium Badge Frame" className="mt-2 w-full rounded border px-2 py-1" /><button type="submit" className="mt-2 rounded bg-primary px-4 py-2 text-sm text-white">Create</button></form>
    </div>
  );
}
