...
export default async function AdminChallengesPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <form className="rounded border p-4 dark:border-gray-700" aria-label="Create challenge form"><h2 className="font-semibold">Create Challenge (stub)</h2><input name="title" placeholder="Challenge title" className="mt-2 w-full rounded border px-2 py-1" /><button type="submit" className="mt-2 rounded bg-primary px-4 py-2 text-sm text-white">Create</button></form>
    </div>
  );
}
